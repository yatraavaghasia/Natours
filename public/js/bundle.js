...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieWF0cmFhIiwiYSI6ImNsbDU2bXIwdjBkdjkzbnJua2x5M3d0NmMifQ.bv8B-bKl4wPmvG4InNN9uQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/yatraa/cll5zyfv700ks01qp7hbr1he3',
    scrollZoom: false
    // center: [-118.324396, 34.097984],
    // zoom: 4
  });
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51Nja35SInAhFqGMsltY5NnLkGNaEHbfko7YOWlM5WgrjBuW298q2AD7ZXtNRQzvzymjTvxk1Xvs0yUFR7uboVLzI003xgv1ypg');
          _context.prev = 1;
          _context.next = 4;
